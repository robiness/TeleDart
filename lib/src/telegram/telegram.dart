...
class Telegram {
  ...
  Future<Message> sendPhoto(dynamic chat_id, dynamic photo,
    ...
    if (photo is io.File) {
      ...
      return Future.error(TelegramException(
          'Attribute \'photo\' can only be either type of io.File or String (Telegram file_id or image url)'));
    }
  ...
  Future<Message> sendAudio(dynamic chat_id, dynamic audio,
    ...
    if (audio is io.File) {
      ...
      return Future.error(TelegramException(
          'Attribute \'audio\' can only be either type of io.File or String (Telegram file_id or image url)'));
    }
    ...
    if (thumb != null) {
      if (thumb is io.File) {
        ...
        return Future.error(TelegramException(
            'Attribute \'thumb\' can only be either type of io.File or String (Telegram file_id or image url)'));
      }
    }
  ...
  Future<Message> sendDocument(dynamic chat_id, dynamic document,
    ...
    if (document is io.File) {
      ...
      return Future.error(TelegramException(
          'Attribute \'document\' can only be either type of io.File or String (Telegram file_id or image url)'));
    }
  ...
  Future<Message> sendVideo(dynamic chat_id, dynamic video,
    ...
    if (video is io.File) {
      ...
      return Future.error(TelegramException(
          'Attribute \'video\' can only be either type of io.File or String (Telegram file_id or image url)'));
    }
  ...
  Future<Message> sendAnimation(dynamic chat_id, dynamic animation,
    ...
    if (animation is io.File) {
      ...
      return Future.error(TelegramException(
          'Attribute \'animation\' can only be either type of io.File or String (Telegram file_id or image url)'));
    }
  ...
  Future<Message> sendVoice(dynamic chat_id, dynamic voice,
    ...
    if (voice is io.File) {
      ...
      return Future.error(TelegramException(
          'Attribute \'voice\' can only be either type of io.File or String (Telegram file_id or image url)'));
    }
  ...
  Future<Message> sendVideoNote(dynamic chat_id, dynamic video_note,
    ...
    if (video_note is io.File) {
      ...
      return Future.error(TelegramException(
          'Attribute \'video_note\' can only be either type of io.File or String (Telegram file_id or image url)'));
    }
  ...
  Future<Message> sendSticker(dynamic chat_id, dynamic sticker,
    ...
    if (sticker is io.File) {
      ...
      return Future.error(TelegramException(
          'Attribute \'sticker\' can only be either type of io.File or String (Telegram file_id or image url)'));
    }
  }
  ...
  Future<bool> createNewStickerSet(
    ...
    if (tgs_sticker == null && png_sticker == null) {
      ...
      return Future.error(TelegramException(
          'Attribute \'png_sticker\' can only be either type of io.File or String (Telegram file_id or image url)'));
    }
  }
